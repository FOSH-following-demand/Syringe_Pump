...
#define PRINTER_NAME "DIY Syringe Pump"  // Change this to whatever you wish, or leave it as it is.
 ...
 */
#define E0_STEPS      16925.3 // Stock extruder. If you have a Tevo Titan, try 400 then calibrate.
 ...
 */
#define Z_STEPS      16925.3 // Stock lead screw
 ...
 * (how to calibrate: https://toms3d.org/2014/04/06/3d-printing-guides-calibrating-your-extruder/)
 */
#define E1_STEPS      16925.3 // Stock extruder. If you have a Tevo Titan, try 400 then calibrate
...
#define STRING_CONFIG_H_AUTHOR "(Drew Porter, Syringe Pump Config)" // Who made the changes.
 ...
 */
#if ENABLED(DUAL_EXTRUDER)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 16925.3, 16925.3, Z_STEPS, E0_STEPS, E1_STEPS }
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 16925.3, 16925.3, Z_STEPS, E0_STEPS }
#endif
